...
arch = [
    ...
    to_cor(),
    env_begin(),
    conv("conv1", 512, 64, offset="(0,0,0)", to="(0,0,0)", height=64, depth=64, width=2 ),
    pool("pool1", offset="(0,0,0)", to="(conv1-east)"),
    conv("conv2", 128, 64, offset="(1,0,0)", to="(pool1-east)", height=32, depth=32, width=2 ),
    to_connection( "pool1", "conv2"),
    pool("pool2", offset="(0,0,0)", to="(conv2-east)", height=28, depth=28, width=1),
    soft_max("soft1", 10 ,"(3,0,0)", "(pool1-east)", caption="SOFT"  ),
