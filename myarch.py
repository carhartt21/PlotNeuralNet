...
arch = [
    ...
    conv_relu(name='ccr_b1', s_filter=500, n_filter=(64, 64, 64, 64, 64), offset="(0, 0, 0)", to="(0, 0, 0)", width=(2, 2, 2, 2, 2), height=40, depth=40),
    pool(name="pool_b1", offset="(0,0,0)", to="(ccr_b1-east)", width=1, height=32, depth=32, opacity=0.5),

    *conv_pool(name='b2', bottom='pool_b1', top='pool_b2', s_filter=256, n_filter=128, offset="(1,0,0)", size=(32, 32, 3.5), opacity=0.5),
    *conv_pool(name='b3', bottom='pool_b2', top='pool_b3', s_filter=128, n_filter=256, offset="(1,0,0)", size=(25, 25, 4.5), opacity=0.5),
    *conv_pool(name='b4', bottom='pool_b3', top='pool_b4', s_filter=64,  n_filter=512, offset="(1,0,0)", size=(16, 16, 5.5), opacity=0.5),
