...
;
	...
	\node[canvas is zy plane at x=0](grid_4) at (pool_4-east) {\drawcoloredgrid{2}{2}{0.25}{black}};
        ...
        \pic[shift={(0, 0, 8)}, ] at (bottleneck_14_connection)
            {BandedBox={
                name=conv_61,
                caption= ,
                xlabel={(512,)},
        ...
        \pic[shift={(0, 0, 8)}, ] at (bottleneck_8_connection)
            {BandedBox={
                name=conv_63,
                caption= ,
                xlabel={(512,)},
        ...
        \pic[shift={(-0.75, 0, 6)}, ] at (sum_3-southwest)
            {BandedBox={
                name=up_3,
                caption= ,
                xlabel={(512,)},
        ...
        \draw [connection]  (up_3-near)    -- node {} ++(0, 0, 6) -- node {\midarrow} (conc_2-west);
