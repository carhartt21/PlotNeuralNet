...
\begin{document}
    \begin{tikzpicture}
        ...
        \draw [connection, ] (conv_5_3-west) -- node [fillwhite] {\midarrow}(up_5_3_0-west);
        ...
        \draw [connection, ] (sum_5_2-west) -- node [fillwhite] {\midarrow}(up_5_2_0-west);
        ...
        \draw [connection, ] (sum_5_1-west) -- node [fillwhite] {\midarrow}(up_5_1_0-west);
        ...
        \pic[shift={(2, 0, 0)}] at (conv_5_0_1-east-west)
            {Box={
                name=soft_max,
                caption= ,
                xlabel={{32,}},
        ...
        \node[canvas is zy plane at x=2] (image_1) at (soft_max-east) {\includegraphics[width=2.5cm ,height=2.5cm ]{\output_image}};

        \draw [connection, ] (soft_max-east) -- node [fillwhite] {\midarrow}(image_1);

        \node[canvas is zy plane at x=3] (image_2) at (image_1.east) {\includegraphics[width=10cm ,height=10cm ]{\output_image}};
