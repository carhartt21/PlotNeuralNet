...
\draw [connection]  (conv_84-east-east) -- node {\midarrow} (conc_1-west);

\path (conv_36-southeast) -- (conv_36-northeast) coordinate[pos=1.25] (conv_36-top) ;
\path (conv_36-top |- conc_1-north) coordinate (conc_1-top)  ;

\draw [connection]  (conv_36-northeast)
-- node {\midline}(conv_36-northeast |- conv_36-top)
-- node {\midarrow}(conv_36-top -| conc_1-north)
-- node {\midline}(conc_1-north);
