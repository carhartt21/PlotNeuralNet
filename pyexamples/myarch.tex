...
\draw [connection]  (add-east) -- node {\midarrow} (mult-west);

\pic[shift={(1,0,0)}] at (mult-east)
    {Ball={
        name=conc,
        caption=,
        fill=\ConcColor,
...
\draw [connection]  (mult-east) -- node {\midarrow} (conc-west);
