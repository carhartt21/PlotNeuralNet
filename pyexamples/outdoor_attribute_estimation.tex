...
% Real Image
	...
	{SolidBox={
			name=attributes,
			label=\Large Attribute \\ \Large estimation,
			fill=gray,
			height=8,
			depth=8,
			width={20}
...
%	\draw [connection] (dummy_0) ++(0,-1) -| node [fillwhite, near start, rotate=180] {\midarrow} (attributes-nearsouth);
	...
	{SolidBox={
			name=sky,
			label=\Large Sky \\ \Large Segmentation,
			fill=gray,
			height=8,
			depth=8,
			width={20}
	...
	\pic[shift={(11, 0, -12)}] at (backbone-east)
	{SolidBox={
			name=cloud,
			label=\Large Cloud \\ \Large Segmentation,
			fill=gray,
			height=8,
			depth=8,
			width={20}
	...
	\draw [connection] (attributes-east) -| node [] {} ++(1.5,0,0) -- node {\midarrow} (sky-nearsouth);	
	...
	\node (att_results_1) [shift={(3,0,0)}, inner sep=15, anchor=west] at (attributes-east) {\Large{Season [Spring, Summer, Autumn, Winter]}};
	\node (att_results_2) [shift={(0,0.5,0)}, inner sep=15, anchor=west] at (att_results_1.west) {\Large{Time [Day, Night, Sunrise/Sunset, Dusk/Dawn]}};
	\node (att_results_3) [shift={(0,-0.5,0)}, inner sep=15, anchor=west] at (att_results_1.west) {\Large{Weather [Sunny, Snow, Rain, Fog]}};
	\draw [connection] (attributes-east) -- node [pos=1] {\midarrow} (att_results_1.west);
