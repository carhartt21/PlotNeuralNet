...
\begin{document}
	...
	\node[canvas is zy plane at x=0](grid_3) at (pool_3-east) {\drawcoloredgrid{2}{2}{0.5}{black}};
    	...
    	\coordinate [shift={(-4, 0, 0)}] (input) at (dummy_pool_2);
        ...
        \draw [connection, ] (input) -- node [fillwhite] {\midarrow}(dummy_pool_2);
        ...
        \draw [connection] ++(1.5, 0, 0)  (input)    -- node {} ++(0, 0, -10) -- node {\midarrow} (dummy_bn_3);
