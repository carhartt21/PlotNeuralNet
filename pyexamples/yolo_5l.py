...
def create_architecture():
    ...
    arch += blocks.conv_relu(name='conv_0', prev='0,0,0', z_label='I', size=(input, input), caption='0', n_filter=32, anchor='')
    ...
    arch += [*blocks.multi_conv_relu(num=3, name='conv', prev='conv_0', layer_num=1, name_start=1,
             n_filter=[64, 32, 64], z_label='I/2', offset='(3,0,0)', size=(input / 2, input / 2),
             conn=True)]
    ...
    arch += [*blocks.upsample(name='conv_86', prev='conv_85', z_label='I/16', n_filter=(256),
    ...
    arch += [*blocks.upsample(name='conv_97', prev='conv_96', z_label='I/8', n_filter=(128),
    ...
    arch += [*blocks.upsample(name='conv_109', prev='conv_108', z_label='I/4', n_filter=(128),
    ...
    arch += [*blocks.multi_conv_relu_z(num=3, name='conv', prev='conv_114', layer_num=115, name_start=115,
                                       n_filter=[64, 128, 256], z_label='I/4', size=(input / 4, input / 4),
                                       conn=True, offset=6)]
    ...
    arch += [*blocks.upsample(name='conv_121', prev='conv_120', z_label='I/2', n_filter=(128),
